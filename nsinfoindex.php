...
/**
 *	\file       nsinfo/nsinfoindex.php
 *	\ingroup    nsinfo
 *	\brief      Home page of nsinfo top menu
 */
...
$langs->loadLangs(array("nsinfo@nsinfo"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->nsinfo->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("NsinfoArea"));

print load_fiche_titre($langs->trans("NsinfoArea"), '', 'nsinfo.png@nsinfo');
...
// Draft MyObject
if (! empty($conf->nsinfo->enabled) && $user->rights->nsinfo->read)
{
	$langs->load("orders");
